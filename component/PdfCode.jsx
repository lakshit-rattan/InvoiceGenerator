...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">Luxury Ride Karnal<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">118, Milestone, NH-1, Karnal, Haryana 132001</div>
    </div>
    ...
    <hr />
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name : <b>HDFC BANK, DHANGARWADI</b><br/>
            Bank Account no : <b>50100272967118</b><br/>
            Bank IFSC code : <b>HDFC0004850</b><br/>
            </p>
